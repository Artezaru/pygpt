...
class Message(object):
    ...
    message : List[Dict[str, str]]
        The list of messages in the conversation, where each message is a dictionary containing a `role` and `content`.

    system_content : Optional[str]
        Gets or sets the content of the system message. If set to `None`, the system message is removed.
    ...
    clear_except_system() -> None
        Clears the message history but retains the system message.
