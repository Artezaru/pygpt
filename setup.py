...
def read_version():
    version_file = "pygpt/__version__.py"
...
setup(
    ...
    url="https://github.com/Artezaru/pygpt.git",  # URL to the package's homepage
    ...
    package_data={
        'pygpt': ['ressources/*'],  # Include all files in ressources/
    },
    entry_points={
        'console_scripts': [
            'pygpt = pygpt.__main__:main',  # Define the pygpt command to run __main__.main()
        ],
    },
)
